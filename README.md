...
The file `review_clean_abap.md` checks against SAP's [Clean ABAP](https://github.com/SAP/styleguides/blob/9e9d325e91e6e682e27d37c8684e412b9e1746f9/clean-abap/CleanABAP_de.md) styleguide; its criteria are a condensed, original-wording summary of that document (© SAP SE and contributors, licensed [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/)).
